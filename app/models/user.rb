class User < ApplicationRecord
  ...
  def make_data
          ...
          l1 = Letter.create(word_id: w1.id, letter:"M", letter2:"_")
          l2 = Letter.create(word_id: w1.id, letter:"E", letter2:"_") 
          l3 = Letter.create(word_id: w1.id, letter: "A", letter2:"_")
          l4 = Letter.create(word_id: w1.id, letter: "T", letter2:"_")
          l5 = Letter.create(word_id: w1.id, letter: "L", letter2:"_")
          l6 = Letter.create(word_id: w1.id, letter: "O", letter2:"_")
          l7 = Letter.create(word_id: w1.id, letter: "A", letter2:"_")
          l8 = Letter.create(word_id: w1.id, letter: "F", letter2:"_")
          l9 = Letter.create(word_id: w2.id, letter: "O", letter2:"_")
          l10 = Letter.create(word_id: w2.id, letter: "L", letter2:"_")
          l11 = Letter.create(word_id: w2.id, letter: "G", letter2:"_")
          l12 = Letter.create(word_id: w2.id, letter: "A", letter2:"_")
