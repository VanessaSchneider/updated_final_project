...
{gtalks === 0 && task.task4===0 ?<div> <h3 className = "riddle-correct"> Stop right there! I don't let anyone cross this bridge. </h3>
<button className = "the-button" onClick = {increment}> Say, "May, I please cross?"</button> </div> : null}
{gtalks ===1 && playGame === false ? <h3 className = "riddle-correct">Okay, I will make you a deal. If you can guess my name. I will let you go across</h3>: null}
{playGame === false  && gtalks ===1 ? <button className = "the-button" onClick={handlePlayGame}>Guess my name game</button> : null}
